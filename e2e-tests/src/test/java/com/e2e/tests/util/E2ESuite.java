...
public class E2ESuite {
    ...
    static class Initializer implements ApplicationContextInitializer<ConfigurableApplicationContext> {
        ...
        public void initialize(ConfigurableApplicationContext context) {
            ...
            serviceDiscoveryContainer = new GenericContainer<>("danielm11/service-discovery:latest")
                    .withNetwork(network)
            ...
            cloudConfigContainer = new GenericContainer<>("danielm11/cloud-config:latest")
                    .withNetwork(network)
            ...
            userServiceContainer = new GenericContainer<>("danielm11/user-service:latest")
                    .withNetwork(network)
            ...
            productServiceContainer = new GenericContainer<>("danielm11/product-service:latest")
                    .withNetwork(network)
            ...
            orderServiceContainer = new GenericContainer<>("danielm11/order-service:latest")
                    .withNetwork(network)
            ...
            paymentServiceContainer = new GenericContainer<>("danielm11/payment-service:latest")
                    .withNetwork(network)
            ...
            favouriteServiceContainer = new GenericContainer<>("danielm11/favourite-service:latest")
                    .withNetwork(network)
